...
window.dom = {
    ...
    create: function create(string) {
        //创建节点
        var container = document.createElement("template"); //template里面可以容纳任意元素，不会在页面中显示，不要用div（因为里面不能直接含td标签）
    ...
    empty: function empty(node) {
        //删除后代
        var childNodes = node.childNodes; // const childNodes =node.childNodes的缩写
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '2550' + '/');
...
//# sourceMappingURL=/dom.e3df8816.map